...
public class VideoFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = v.findViewById(R.id.videoId);
        VideosCustomAdapter videosCustomAdapter = new VideosCustomAdapter(getContext(), MainActivity.videoList);
        recyclerView.setAdapter(videosCustomAdapter);
